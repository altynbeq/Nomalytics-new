...
const EarlyRevenueStats = () => {
  ...
  return (
    <div className="bg-white dark:text-gray-200 justify-center text-center align-center dark:bg-secondary-dark-bg m-5 md:m-1 p-4 rounded-2xl m5 w-[80%] md:w-[30%]   ">
